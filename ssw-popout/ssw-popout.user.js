...
if ( window.location.pathname == "/ssw-popout" && document.title != "SSW" ) {
	...
	e.textContent = "jQuery('#search-form #area').append('<p><a style=\"cursor: pointer;\" onclick=\"javascript: window.open(\\\'/ssw-popout\\\', \\\'SSWwindow\\\', \\\'height=284,width=612,status=0,toolbar=0,resizable=0,scrollbars=0,location=0,menubar=0,toolbar=0\\\');\">SSW Popout</a></p>')";
